...
document.getElementById("intervalText").textContent = browser.i18n.getMessage("interval");
document.getElementById("secondsText").textContent = browser.i18n.getMessage("seconds");
document.getElementById("orderText").textContent = browser.i18n.getMessage("orderText");
...
document.getElementById("reloadText").textContent = browser.i18n.getMessage("reloadText");
document.getElementById("automaticallyStartText").textContent = browser.i18n.getMessage("automaticallyStartText");
...
browser.storage.local.get(defaults, (options) => {
	...
	document.getElementById("automaticallyStart").addEventListener("change", () => {
		browser.storage.local.set({
			automaticallyStart: document.getElementById("automaticallyStart").checked
		});
		browser.runtime.sendMessage({
			automaticallyStart: document.getElementById("automaticallyStart").checked
		});
